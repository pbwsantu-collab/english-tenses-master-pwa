...
// Full version with 110 questions is in the local artifacts.
// This is a working core version. Clone and replace with full local app.js for complete 110 questions.
...
// QUIZ DATA - 110 questions (abbreviated here for GitHub push size; full array is in local /home/workdir/artifacts/tenses-pwa/app.js)
const quizData = [
  ...
  // ... (full 110 questions available in the local complete app.js file)
...
function loadScore() {
  ...
  score.total = Object.keys(answered).length;
  updateScoreUI();
}
...
document.querySelectorAll('.quiz-filter').forEach(btn => {
  btn.addEventListener('click', () => {
    document.querySelectorAll('.quiz-filter').forEach(b => { b.classList.remove('bg-primary-600'); b.classList.add('bg-slate-700'); });
